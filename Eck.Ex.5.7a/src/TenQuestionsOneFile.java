/** Eck Exercise 5.7 solution
 * 
 */

import textio.TextIO;

public class TenQuestionsOneFile {
    ...
    static class GeneralQuestion implements IntQuestion {
    ...
    private static int[] userAnswers;   // The user"s answers t
    ...
    private static void createQuiz() {
        ...
        questions[9] = new GeneralQuestion("What is forty-two?", 42);
